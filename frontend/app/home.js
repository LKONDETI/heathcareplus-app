    ...
    <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: 32 }}>
      ...
      <Card>
        ...
        <View style={styles.actionsRow}>
          <Link href="/appointments" style={styles.chip}>
            <Text style={styles.chipText}>View appointments</Text>
          </Link>
          <Link href="/records" style={styles.chip}>
            <Text style={styles.chipText}>Medical records</Text>
          </Link>
          <Link href="/profile" style={styles.chip}>
      ...
      <Card>
        ...
        <Text style={styles.cardText}>
          Stay hydrated, keep moving, and don’t forget regular checkups with your doctor.
        </Text>
      </Card>
    </ScrollView>
  );
